...
def test_calculate_seo_score_missing_tech_flags():
...
def test_calculate_seo_score_analytics_or_gtm():
...
def test_calculate_seo_score_robots_and_sitemap():
